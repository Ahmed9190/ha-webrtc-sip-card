(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.WebRTCSipCard = {}));
...
\f\r"'\`<>=]|("|')|))|$)`, "g"), p = /'/g, g = /"/g, $ = /^(?:script|style|textarea|title)$/i, y = (t2) => (i2, ...s2) => ({ _$litType$: t2, strings: i2, values: s2 }), x = y(1), T = Symbol.for("lit-noChange"), E = Symbol.for("lit-nothing"), A = /* @__PURE__ */ new WeakMap(), C$1 = r$2.createTreeWalker(r$2, 129);
  function P(t2, i2) {
  ...
  class N {
    constructor({ strings: t2, _$litType$: s2 }, n2) {
      ...
      if (this.el = N.createElement(f2, n2), C$1.currentNode = this.el.content, 2 === s2 || 3 === s2) {
        ...
        if (1 === r2.nodeType) {
          ...
          if ($.test(r2.tagName)) {
            ...
            if (s3 > 0) {
              ...
              for (let i2 = 0; i2 < s3; i2++) r2.append(t3[i2], l()), C$1.nextNode(), d2.push({ type: 2, index: ++c2 });
              r2.append(t3[s3], l());
            }
          }
   ...
   */
  function r(r2) {
    return n(__spreadProps(__spreadValues({}, r2), { state: true, attribute: false }));
  }
  /**
   * @license
   * Copyright 2017 Google LLC
  ...
  function e(e2, r2) {
    return (n2, s2, i2) => {
      const o2 = (t2) => {
        var _a2, _b2;
        return (_b2 = (_a2 = t2.renderRoot) == null ? void 0 : _a2.querySelector(e2)) != null ? _b2 : null;
      };
  ...
  class SipManager extends EventTarget {
    ...
    async enableVideo() {
      ...
      if (this.isEnablingVideo) {
        debugLog(((_a2 = this.config) == null ? void 0 : _a2.debug) || false, "Video is already being enabled, ignoring duplicate request");
        return;
      }
      try {
        ...
        debugLog(((_b2 = this.config) == null ? void 0 : _b2.debug) || false, "Local video enabled with new stream:", {
          videoTracks: stream.getVideoTracks().length,
          audioTracks: stream.getAudioTracks().length,
          streamId: stream.id
        });
        if (((_c2 = this.simpleUser) == null ? void 0 : _c2.session) && ((_d2 = this.currentCall) == null ? void 0 : _d2.state) === "connected") {
      ...
      try {
        ...
        if (this.localStream) {
          this.localStream.getTracks().forEach((track) => {
            var _a3;
            track.stop();
            debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, `Stopped ${track.kind} track:`, track.id);
          });
        }
        this.localStream = audioOnlyStream;
        this.videoEnabled = false;
        debugLog(((_a2 = this.config) == null ? void 0 : _a2.debug) || false, "Local video disabled, using audio-only stream:", {
        ...
        if (((_b2 = this.simpleUser) == null ? void 0 : _b2.session) && ((_c2 = this.currentCall) == null ? void 0 : _c2.state) === "connected") {
    ...
    async replaceMediaTracks(newStream) {
      ...
      try {
        const session = (_a2 = this.simpleUser) == null ? void 0 : _a2.session;
        if (!session || !session.sessionDescriptionHandler) {
          debugLog(((_b2 = this.config) == null ? void 0 : _b2.debug) || false, "No active session to replace tracks");
          return;
        }
        const pc = session.sessionDescriptionHandler.peerConnection;
        if (!pc) {
          debugLog(((_c2 = this.config) == null ? void 0 : _c2.debug) || false, "No peer connection found");
          return;
        }
        ...
        if (audioSender && audioTrack) {
          ...
          debugLog(((_d2 = this.config) == null ? void 0 : _d2.debug) || false, "Audio track replaced successfully");
        }
        const videoTrack = newStream.getVideoTracks()[0] || null;
        const videoSender = senders.find((sender) => sender.track && sender.track.kind === "video");
        if (videoSender) {
          await videoSender.replaceTrack(videoTrack);
          debugLog(((_e2 = this.config) == null ? void 0 : _e2.debug) || false, videoTrack ? "Video track replaced" : "Video track removed from sender");
        } else if (videoTrack) {
          try {
            pc.addTrack(videoTrack, newStream);
            debugLog(((_f2 = this.config) == null ? void 0 : _f2.debug) || false, "Video track added to peer connection");
    ...
    setupRemoteStreamHandlers(session) {
      ...
      try {
        ...
        if (!sessionDescriptionHandler) {
          debugLog(((_a2 = this.config) == null ? void 0 : _a2.debug) || false, "No session description handler");
          return;
        }
        const pc = sessionDescriptionHandler.peerConnection;
        if (!pc) {
          debugLog(((_b2 = this.config) == null ? void 0 : _b2.debug) || false, "No peer connection");
          return;
        }
        debugLog(((_c2 = this.config) == null ? void 0 : _c2.debug) || false, "Setting up remote stream handlers for", pc.connectionState);
        pc.ontrack = (event) => {
          var _a3, _b3, _c3, _d2, _e2;
          debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "Remote track received:", {
          ...
          if (!stream) {
            debugLog(((_b3 = this.config) == null ? void 0 : _b3.debug) || false, "No stream in track event");
            return;
          }
          if (event.track.kind === "audio") {
            if (this.remoteAudio) {
              this.remoteAudio.srcObject = stream;
              debugLog(((_c3 = this.config) == null ? void 0 : _c3.debug) || false, "Remote audio stream attached");
            }
            ...
            if (this.remoteVideo) {
              ...
              this.remoteVideo.autoplay = true;
              this.remoteVideo.playsInline = true;
              debugLog(((_d2 = this.config) == null ? void 0 : _d2.debug) || false, "Remote video stream attached, playing...");
              if (this.remoteVideo.srcObject) {
                const playPromise = this.remoteVideo.play();
                if (playPromise !== void 0) {
                  playPromise.then(() => {
                    var _a4;
                    debugLog(((_a4 = this.config) == null ? void 0 : _a4.debug) || false, "Remote video playing successfully");
                  }).catch((error) => {
                    var _a4, _b4, _c4;
                    debugLog(((_a4 = this.config) == null ? void 0 : _a4.debug) || false, "Remote video play failed:", error);
                    if (error.name === "NotAllowedError") {
                      debugLog(((_b4 = this.config) == null ? void 0 : _b4.debug) || false, "Video play not allowed, likely due to autoplay restrictions");
                      if (this.remoteVideo) {
                        ...
                        if (retryPromise !== void 0) {
                          retryPromise.catch((retryError) => {
                            var _a5;
                            debugLog(((_a5 = this.config) == null ? void 0 : _a5.debug) || false, "Muted video play retry failed:", retryError);
                                ...
                                if (this.remoteVideo && this.remoteVideo.srcObject) {
                                  ...
                                  if (finalPromise !== void 0) {
                                    finalPromise.catch((finalError) => {
                                      var _a6;
                                      debugLog(((_a6 = this.config) == null ? void 0 : _a6.debug) || false, "Final video play attempt failed:", finalError);
                                    });
                                  }
                                }
                              }, 100);
                      ...
                      debugLog(((_c4 = this.config) == null ? void 0 : _c4.debug) || false, "Video play was interrupted, this is normal during stream updates");
                      setTimeout(() => {
                        if (this.remoteVideo && this.remoteVideo.srcObject) {
                          if (this.remoteVideo.readyState >= 2) {
                            ...
                            if (retryPromise !== void 0) {
                              retryPromise.catch((retryError) => {
                                var _a5;
                                debugLog(((_a5 = this.config) == null ? void 0 : _a5.debug) || false, "Video play retry failed:", retryError);
                              });
                            }
                          } else {
                            setTimeout(() => {
                              if (this.remoteVideo && this.remoteVideo.srcObject) {
                                ...
                                if (retryPromise !== void 0) {
                                  retryPromise.catch((retryError) => {
                                    var _a5;
                                    debugLog(((_a5 = this.config) == null ? void 0 : _a5.debug) || false, "Delayed video play retry failed:", retryError);
                                  });
                                }
                              }
                            }, 200);
                        ...
                        setTimeout(() => {
                          if (this.remoteVideo && this.remoteVideo.srcObject) {
                            ...
                            if (retryPromise !== void 0) {
                              retryPromise.catch((retryError) => {
                                var _a5;
                                debugLog(((_a5 = this.config) == null ? void 0 : _a5.debug) || false, "Remote video play retry failed:", retryError);
                              });
                            }
                          }
                        }, 100);
              ...
              debugLog(((_e2 = this.config) == null ? void 0 : _e2.debug) || false, "Video track details:", {
        ...
        pc.oniceconnectionstatechange = () => {
          var _a3;
          debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "ICE connection state changed:", pc.iceConnectionState);
        ...
        pc.onicegatheringstatechange = () => {
          var _a3;
          debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "ICE gathering state changed:", pc.iceGatheringState);
        };
        pc.onicecandidate = (event) => {
          var _a3, _b3;
          if (event.candidate) {
            debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "ICE candidate:", event.candidate.type, event.candidate.candidate);
          } else {
            debugLog(((_b3 = this.config) == null ? void 0 : _b3.debug) || false, "ICE gathering complete");
          }
        };
        pc.onconnectionstatechange = () => {
          var _a3;
          debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "Connection state changed:", pc.connectionState);
          if (pc.connectionState === "failed") {
            ...
            setTimeout(() => {
              ...
              debugLog(((_a4 = this.config) == null ? void 0 : _a4.debug) || false, "Checking transceivers:", transceivers.length);
              transceivers.forEach((transceiver, index2) => {
                var _a5, _b3, _c3, _d2, _e2, _f2, _g, _h, _i, _j;
                debugLog(((_a5 = this.config) == null ? void 0 : _a5.debug) || false, `Transceiver ${index2}:`, {
                  direction: transceiver.direction,
                  kind: (_c3 = (_b3 = transceiver.receiver) == null ? void 0 : _b3.track) == null ? void 0 : _c3.kind,
                  trackState: (_e2 = (_d2 = transceiver.receiver) == null ? void 0 : _d2.track) == null ? void 0 : _e2.readyState,
                  hasTrack: !!((_f2 = transceiver.receiver) == null ? void 0 : _f2.track)
                });
        ...
        pc.onremovetrack = (event) => {
          var _a3;
          debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "Remote track removed:", event.track.kind);
    ...
    handleIceConnectionFailure(pc) {
      var _a2;
      debugLog(((_a2 = this.config) == null ? void 0 : _a2.debug) || false, "Attempting ICE restart");
      setTimeout(() => {
        var _a3;
        if (pc.iceConnectionState === "failed") {
          try {
            pc.restartIce();
            debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "ICE restart initiated");
          } catch (error) {
    ...
    async waitForSipLibrary(timeout = 15e3) {
      return new Promise((resolve, reject) => {
        ...
        const continueCheck = () => {
          ...
          try {
            ...
            if (isFullyLoaded) {
              ...
              debugLog(((_a2 = this.config) == null ? void 0 : _a2.debug) || false, "SIP.js library fully loaded and verified");
              resolve();
              return;
            }
        ...
        const checkLibrary = () => {
          if (!Web) {
            Promise.resolve().then(() => index).then((SIP) => {
              Web = SIP.Web || SIP;
              continueCheck();
            }).catch(() => {
              setTimeout(checkLibrary, 200);
    ...
    setupEventHandlers() {
      ...
      debugLog(((_a2 = this.config) == null ? void 0 : _a2.debug) || false, "Setting up event handlers");
      this.simpleUser.delegate = {
        onCallCreated: () => {
          var _a3;
          debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "Call created");
          this.dispatchEvent(new CustomEvent("callCreated"));
        },
        onCallReceived: () => {
          var _a3, _b2, _c2, _d2, _e2, _f2, _g, _h, _i, _j, _k, _l, _m;
          debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "Incoming call received");
          const session = (_b2 = this.simpleUser) == null ? void 0 : _b2.session;
          if (!session) {
            debugLog(((_c2 = this.config) == null ? void 0 : _c2.debug) || false, "No session found for incoming call");
            return;
          }
          let remoteIdentity = "unknown";
          let displayName = "Unknown Caller";
          try {
            debugLog(((_d2 = this.config) == null ? void 0 : _d2.debug) || false, "Current session state:", session.state);
            this.setupRemoteStreamHandlers(session);
            if (session.request) {
              const fromHeader = session.request.getHeader("From");
              debugLog(((_e2 = this.config) == null ? void 0 : _e2.debug) || false, "From header:", fromHeader);
              if (fromHeader) {
                const uriMatches = fromHeader.match(/<sip:([^@]+)@/) || fromHeader.match(/sip:([^@]+)@/);
                if (uriMatches && uriMatches[1]) {
                  remoteIdentity = uriMatches[1];
                  debugLog(((_f2 = this.config) == null ? void 0 : _f2.debug) || false, "Extracted extension from From:", remoteIdentity);
                }
        ...
        onCallAnswered: () => {
          ...
          debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "Call answered");
          if ((_b2 = this.simpleUser) == null ? void 0 : _b2.session) {
            const session = this.simpleUser.session;
            this.setupRemoteStreamHandlers(session);
            session.stateChange.addListener((newState) => {
              var _a4, _b3;
              debugLog(((_a4 = this.config) == null ? void 0 : _a4.debug) || false, "Incoming session state changed:", newState);
              switch (newState) {
                case "Terminated":
                case "Ended":
                  debugLog(((_b3 = this.config) == null ? void 0 : _b3.debug) || false, "Incoming call ended");
                  if (this.localStream) {
                    this.localStream.getTracks().forEach((track) => {
                      var _a5, _b4;
                      try {
                        track.stop();
                        debugLog(((_a5 = this.config) == null ? void 0 : _a5.debug) || false, `Stopped local media track on incoming call end: ${track.kind}`);
                      } catch (error) {
                        debugLog(((_b4 = this.config) == null ? void 0 : _b4.debug) || false, `Failed to stop track on incoming call end: ${track.kind}`, error);
                      }
                    });
                    this.localStream = null;
                  }
        ...
        onCallHangup: () => {
          var _a3;
          debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "Call ended");
          if (this.localStream) {
            this.localStream.getTracks().forEach((track) => {
              var _a4, _b2;
              try {
                track.stop();
                debugLog(((_a4 = this.config) == null ? void 0 : _a4.debug) || false, `Stopped local media track: ${track.kind}`);
              } catch (error) {
                debugLog(((_b2 = this.config) == null ? void 0 : _b2.debug) || false, `Failed to stop track: ${track.kind}`, error);
              }
            });
            this.localStream = null;
          }
        ...
        onCallHold: (held) => {
          var _a3;
          debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "Call hold state changed", held);
          this.dispatchEvent(
        ...
        onRegistered: () => {
          var _a3;
          this.isRegistered = true;
          debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "Registration successful");
          this.dispatchEvent(new CustomEvent("registered", { detail: { registered: true } }));
        },
        onUnregistered: () => {
          var _a3;
          this.isRegistered = false;
          debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "Unregistered");
          this.dispatchEvent(new CustomEvent("registered", { detail: { registered: false } }));
        },
        onServerConnect: () => {
          var _a3;
          this.isConnected = true;
          debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "Server connected");
          this.dispatchEvent(new CustomEvent("connected"));
        },
        onServerDisconnect: () => {
          var _a3;
          this.isConnected = false;
          this.isRegistered = false;
          debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "Server disconnected");
    ...
    startConnectionMonitoring() {
      this.connectionTimer = window.setInterval(() => {
        var _a2;
        const connected = ((_a2 = this.simpleUser) == null ? void 0 : _a2.isConnected()) || false;
    ...
    async makeCall(target, includeVideo = true) {
      ...
      try {
        ...
        debugLog(((_a2 = this.config) == null ? void 0 : _a2.debug) || false, "Making VIDEO call to", targetUri, "with video:", includeVideo);
        if (!this.videoEnabled) {
          await this.enableVideo();
        }
        ...
        if (this.simpleUser.session) {
          const session = this.simpleUser.session;
          debugLog(((_b2 = this.config) == null ? void 0 : _b2.debug) || false, "Outgoing call session created, state:", session.state);
          this.setupRemoteStreamHandlers(session);
          session.stateChange.addListener((newState) => {
            var _a3, _b3, _c2, _d2;
            debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "Outgoing session state changed:", newState);
            switch (newState) {
              case "Establishing":
                debugLog(((_b3 = this.config) == null ? void 0 : _b3.debug) || false, "Call is establishing, setting up stream handlers");
                this.setupRemoteStreamHandlers(session);
                break;
              case "Established":
                debugLog(((_c2 = this.config) == null ? void 0 : _c2.debug) || false, "Call established, ensuring stream handlers");
                setTimeout(() => {
                  this.setupRemoteStreamHandlers(session);
                  this.forceRemoteVideoCheck(session);
                }, 100);
              ...
              case "Terminated":
              case "Ended":
                debugLog(((_d2 = this.config) == null ? void 0 : _d2.debug) || false, "Outgoing call ended");
                if (this.localStream) {
                  this.localStream.getTracks().forEach((track) => {
                    var _a4, _b4;
                    try {
                      track.stop();
                      debugLog(((_a4 = this.config) == null ? void 0 : _a4.debug) || false, `Stopped local media track on outgoing call end: ${track.kind}`);
                    } catch (error) {
                      debugLog(((_b4 = this.config) == null ? void 0 : _b4.debug) || false, `Failed to stop track on outgoing call end: ${track.kind}`, error);
                    }
                  });
                  this.localStream = null;
                }
          ...
          const checkForSDH = () => {
            ...
            if (session.sessionDescriptionHandler) {
              debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, "Session description handler available for outgoing call");
              this.setupRemoteStreamHandlers(session);
            } else {
        ...
        if (this.localStream) {
          this.localStream.getTracks().forEach((track) => {
            ...
            try {
              track.stop();
              debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, `Stopped local media track on call failure: ${track.kind}`);
            } catch (trackError) {
              debugLog(((_b3 = this.config) == null ? void 0 : _b3.debug) || false, `Failed to stop track on call failure: ${track.kind}`, trackError);
            }
          });
          this.localStream = null;
        }
    ...
    forceRemoteVideoCheck(session) {
      ...
      try {
        if (!session || !session.sessionDescriptionHandler) {
          debugLog(((_a2 = this.config) == null ? void 0 : _a2.debug) || false, "No session description handler for video check");
          return;
        }
        const pc = session.sessionDescriptionHandler.peerConnection;
        if (!pc) {
          debugLog(((_b2 = this.config) == null ? void 0 : _b2.debug) || false, "No peer connection for video check");
          return;
        }
        debugLog(((_c2 = this.config) == null ? void 0 : _c2.debug) || false, "Forcing remote video check, connection state:", pc.connectionState);
        const remoteStreams = pc.getRemoteStreams ? pc.getRemoteStreams() : [];
        debugLog(((_d2 = this.config) == null ? void 0 : _d2.debug) || false, "Remote streams found:", remoteStreams.length);
        if (remoteStreams.length > 0) {
          const remoteStream = remoteStreams[0];
          const videoTracks = remoteStream.getVideoTracks();
          debugLog(((_e2 = this.config) == null ? void 0 : _e2.debug) || false, "Found remote stream with video tracks:", videoTracks.length);
        ...
        const transceivers = pc.getTransceivers();
        debugLog(((_f2 = this.config) == null ? void 0 : _f2.debug) || false, "Checking transceivers for outgoing call:", transceivers.length);
        transceivers.forEach((transceiver, index2) => {
          var _a3, _b3, _c3;
          if (((_b3 = (_a3 = transceiver.receiver) == null ? void 0 : _a3.track) == null ? void 0 : _b3.kind) === "video" && transceiver.receiver.track.readyState === "live") {
            debugLog(((_c3 = this.config) == null ? void 0 : _c3.debug) || false, `Found active video transceiver ${index2} for outgoing call`);
            if (this.remoteVideo && !this.remoteVideo.srcObject) {
              ...
              if (this.remoteVideo.srcObject) {
                ...
                if (playPromise !== void 0) {
                  playPromise.then(() => {
                    var _a4;
                    debugLog(((_a4 = this.config) == null ? void 0 : _a4.debug) || false, "Transceiver video playing successfully");
                  }).catch((error) => {
                    var _a4;
                    debugLog(((_a4 = this.config) == null ? void 0 : _a4.debug) || false, "Transceiver video play failed:", error);
                    if (this.remoteVideo && this.remoteVideo.srcObject) {
                      const currentStream = this.remoteVideo.srcObject;
                      this.remoteVideo.srcObject = null;
                      this.remoteVideo.srcObject = currentStream;
                        ...
                        if (this.remoteVideo && this.remoteVideo.srcObject) {
                          if (this.remoteVideo.readyState >= 2) {
                            ...
                            if (retryPromise !== void 0) {
                              retryPromise.catch((retryError) => {
                                var _a5;
                                debugLog(((_a5 = this.config) == null ? void 0 : _a5.debug) || false, "Transceiver video play retry failed:", retryError);
                              });
                            }
                          } else {
                            setTimeout(() => {
                              if (this.remoteVideo && this.remoteVideo.srcObject) {
                                ...
                                if (retryPromise !== void 0) {
                                  retryPromise.catch((retryError) => {
                                    var _a5;
                                    debugLog(((_a5 = this.config) == null ? void 0 : _a5.debug) || false, "Delayed transceiver video play retry failed:", retryError);
                                  });
                                }
                              }
                            }, 200);
    ...
    async answerCall() {
      ...
      debugLog(((_a2 = this.config) == null ? void 0 : _a2.debug) || false, "Attempting to answer call, session state:", sessionState);
      ...
      try {
        ...
        debugLog(((_b2 = this.config) == null ? void 0 : _b2.debug) || false, "Call answered with video:", this.videoEnabled);
        if (this.simpleUser.session) {
        ...
        if (this.localStream) {
          this.localStream.getTracks().forEach((track) => {
            ...
            try {
              track.stop();
              debugLog(((_a3 = this.config) == null ? void 0 : _a3.debug) || false, `Stopped local media track on answer failure: ${track.kind}`);
            } catch (trackError) {
              debugLog(((_b3 = this.config) == null ? void 0 : _b3.debug) || false, `Failed to stop track on answer failure: ${track.kind}`, trackError);
            }
          });
          this.localStream = null;
        }
    ...
    async rejectCall() {
      ...
      try {
        ...
        this.currentCall = null;
        debugLog(((_a2 = this.config) == null ? void 0 : _a2.debug) || false, "Call rejected");
      } catch (error) {
    ...
    async hangup() {
      ...
      try {
        ...
        debugLog(((_a2 = this.config) == null ? void 0 : _a2.debug) || false, "Call hung up");
      } catch (error) {
    ...
    async mute() {
      ...
      try {
        ...
        debugLog(((_a2 = this.config) == null ? void 0 : _a2.debug) || false, "Call muted");
      } catch (error) {
    ...
    async unmute() {
      ...
      try {
        ...
        debugLog(((_a2 = this.config) == null ? void 0 : _a2.debug) || false, "Call unmuted");
      } catch (error) {
    ...
    sendDTMF(tone) {
      ...
      try {
        if (typeof this.simpleUser.sendDTMF === "function") {
          ...
          debugLog(((_a2 = this.config) == null ? void 0 : _a2.debug) || false, "DTMF sent", tone);
          this.dispatchEvent(
    ...
    async disconnect() {
      ...
      debugLog(((_a2 = this.config) == null ? void 0 : _a2.debug) || false, "SIP client disconnected");
    }
  }
...
`;
  ...
  exports2.WebRTCSipCard = class WebRTCSipCard extends i {
    constructor() {
      super(...arguments);
    ...
    setupEventHandlers() {
      ...
      this.sipManager.addEventListener("localVideoChanged", (_event) => {
        var _a2;
        this.callState = ((_a2 = this.callManager) == null ? void 0 : _a2.getCallState()) || this.callState;
        this.requestUpdate();
      });
      ...
      this.callManager.addEventListener("callStateChanged", (event) => {
        var _a2;
        const wasActive = (_a2 = this.callState) == null ? void 0 : _a2.active;
    ...
    startRemoteVideoMonitoring() {
      ...
      this.remoteVideoCheckInterval = window.setInterval(() => {
        var _a2;
        const remoteVideo = (_a2 = this.callManager) == null ? void 0 : _a2.getRemoteVideo();
        if (remoteVideo && remoteVideo.srcObject) {
          const stream = remoteVideo.srcObject;
      ...
      if (this.callState.active && this.remoteVideoElement) {
        ...
        if (remoteVideo && remoteVideo.srcObject) {
          console.log("Updating remote video element:", {
            ...
            videoTracks: ((_b2 = remoteVideo.srcObject) == null ? void 0 : _b2.getVideoTracks().length) || 0
          });
  ...
  __decorateClass([
    n({ attribute: false })
  ], exports2.WebRTCSipCard.prototype, "hass", 2);
  __decorateClass([
    r()
  ], exports2.WebRTCSipCard.prototype, "config", 2);
  __decorateClass([
    r()
  ], exports2.WebRTCSipCard.prototype, "connected", 2);
  __decorateClass([
    r()
  ], exports2.WebRTCSipCard.prototype, "registered", 2);
  __decorateClass([
    r()
  ], exports2.WebRTCSipCard.prototype, "error", 2);
  __decorateClass([
    r()
  ], exports2.WebRTCSipCard.prototype, "callState", 2);
  __decorateClass([
    r()
  ], exports2.WebRTCSipCard.prototype, "showKeypad", 2);
  __decorateClass([
    r()
  ], exports2.WebRTCSipCard.prototype, "currentInput", 2);
  __decorateClass([
    r()
  ], exports2.WebRTCSipCard.prototype, "callDuration", 2);
  __decorateClass([
    r()
  ], exports2.WebRTCSipCard.prototype, "remoteVideoAvailable", 2);
  __decorateClass([
    r()
  ], exports2.WebRTCSipCard.prototype, "connectionAttempts", 2);
  __decorateClass([
    r()
  ], exports2.WebRTCSipCard.prototype, "isRetrying", 2);
  __decorateClass([
    e("#remote-video")
  ], exports2.WebRTCSipCard.prototype, "remoteVideoElement", 2);
  exports2.WebRTCSipCard = __decorateClass([
    t("ha-webrtc-sip-card")
  ], exports2.WebRTCSipCard);
  ...
  function equivalentURI(a2, b2) {
    if (a2.scheme !== b2.scheme) {
      return false;
    }
    if (a2.user !== b2.user || a2.host !== b2.host || a2.port !== b2.port) {
      return false;
    }
    function compareParameters(a3, b3) {
      const parameterKeysA = Object.keys(a3.parameters);
      const parameterKeysB = Object.keys(b3.parameters);
      const intersection = parameterKeysA.filter((x2) => parameterKeysB.includes(x2));
      if (!intersection.every((key) => a3.parameters[key] === b3.parameters[key])) {
        return false;
      }
      if (!["user", "ttl", "method", "transport"].every((key) => a3.hasParam(key) && b3.hasParam(key) || !a3.hasParam(key) && !b3.hasParam(key))) {
        return false;
      }
      if (!["maddr"].every((key) => a3.hasParam(key) && b3.hasParam(key) || !a3.hasParam(key) && !b3.hasParam(key))) {
        return false;
      }
      return true;
    }
    if (!compareParameters(a2, b2)) {
      return false;
    }
    const headerKeysA = Object.keys(a2.headers);
    const headerKeysB = Object.keys(b2.headers);
    if (headerKeysA.length !== 0 || headerKeysB.length !== 0) {
      if (headerKeysA.length !== headerKeysB.length) {
        return false;
      }
      const intersection = headerKeysA.filter((x2) => headerKeysB.includes(x2));
      if (intersection.length !== headerKeysB.length) {
        return false;
      }
      if (!intersection.every((key) => a2.headers[key].length && b2.headers[key].length && a2.headers[key][0] === b2.headers[key][0])) {
        return false;
      }
    }
    return true;
  ...
  class Session {
    ...
    setupSessionDescriptionHandler() {
      ...
      if ((_a2 = this.delegate) === null || _a2 === void 0 ? void 0 : _a2.onSessionDescriptionHandler) {
...
`;
  ...
  class SubscriptionDialog extends Dialog {
    ...
    subscribe(delegate, options = {}) {
      ...
      if (!((_a2 = options.extraHeaders) === null || _a2 === void 0 ? void 0 : _a2.includes("Expires: 0"))) {
  ...
  class SessionDescriptionHandler {
    ...
    getDescription(options, modifiers) {
      ...
      const iceRestart = (_a2 = options === null || options === void 0 ? void 0 : options.offerOptions) === null || _a2 === void 0 ? void 0 : _a2.iceRestart;
      const iceTimeout = (options === null || options === void 0 ? void 0 : options.iceGatheringTimeout) === void 0 ? (_b2 = this.sessionDescriptionHandlerConfiguration) === null || _b2 === void 0 ? void 0 : _b2.iceGatheringTimeout : options === null || options === void 0 ? void 0 : options.iceGatheringTimeout;
    ...
    setLocalMediaStream(stream) {
      ...
      return trackUpdates.reduce((p2, x2) => p2.then(() => x2), Promise.resolve());
    }
    /**
    ...
    initPeerConnectionEventHandlers() {
      ...
      peerConnection.onconnectionstatechange = (event) => {
        ...
        if ((_a2 = this._peerConnectionDelegate) === null || _a2 === void 0 ? void 0 : _a2.onconnectionstatechange) {
      ...
      peerConnection.ondatachannel = (event) => {
        ...
        if ((_a2 = this._peerConnectionDelegate) === null || _a2 === void 0 ? void 0 : _a2.ondatachannel) {
      ...
      peerConnection.onicecandidate = (event) => {
        ...
        if ((_a2 = this._peerConnectionDelegate) === null || _a2 === void 0 ? void 0 : _a2.onicecandidate) {
      ...
      peerConnection.onicecandidateerror = (event) => {
        ...
        if ((_a2 = this._peerConnectionDelegate) === null || _a2 === void 0 ? void 0 : _a2.onicecandidateerror) {
      ...
      peerConnection.oniceconnectionstatechange = (event) => {
        ...
        if ((_a2 = this._peerConnectionDelegate) === null || _a2 === void 0 ? void 0 : _a2.oniceconnectionstatechange) {
      ...
      peerConnection.onicegatheringstatechange = (event) => {
        ...
        if ((_a2 = this._peerConnectionDelegate) === null || _a2 === void 0 ? void 0 : _a2.onicegatheringstatechange) {
      ...
      peerConnection.onnegotiationneeded = (event) => {
        ...
        if ((_a2 = this._peerConnectionDelegate) === null || _a2 === void 0 ? void 0 : _a2.onnegotiationneeded) {
      ...
      peerConnection.onsignalingstatechange = (event) => {
        ...
        if ((_a2 = this._peerConnectionDelegate) === null || _a2 === void 0 ? void 0 : _a2.onsignalingstatechange) {
      ...
      peerConnection.ontrack = (event) => {
        ...
        if ((_a2 = this._peerConnectionDelegate) === null || _a2 === void 0 ? void 0 : _a2.ontrack) {
      ...
      switch (this.state) {
        ...
        case TransportState.Disconnecting:
          ...
          try {
            ...
            if (e2 instanceof StateTransitionError) {
              return Promise.reject(e2);
            }
            throw e2;
          }
    ...
    initCore() {
      ...
      const userAgentCoreDelegate = {
        onInvite: (incomingInviteRequest) => {
          ...
          if ((_a2 = this.delegate) === null || _a2 === void 0 ? void 0 : _a2.onInvite) {
            if (invitation.autoSendAnInitialProvisionalResponse) {
              invitation.progress().then(() => {
                var _a3;
                if (((_a3 = this.delegate) === null || _a3 === void 0 ? void 0 : _a3.onInvite) === void 0) {
  ...
  const stripPayload = (sdp, payload) => {
    ...
    for (const mediaDesc of mediaDescs) {
      ...
      for (let j2 = 3; j2 < mline.length; ) {
        if (mediaDesc.stripped.indexOf(mline[j2]) !== -1) {
          mline.splice(j2, 1);
          continue;
        }
        j2++;
  ...
  function startLocalConference(conferenceSessions) {
    ...
    const pairs = (arr) => arr.map((v2, i2) => arr.slice(i2 + 1).map((w) => [v2, w])).reduce((acc, curVal) => acc.concat(curVal), []);
  ...
  class SessionManager {
    ...
    getLocalAudioTrack(session) {
      var _a2;
      return (_a2 = this.getLocalMediaStream(session)) === null || _a2 === void 0 ? void 0 : _a2.getTracks().find((track) => track.kind === "audio");
    }
    /**
    ...
    getLocalVideoTrack(session) {
      var _a2;
      return (_a2 = this.getLocalMediaStream(session)) === null || _a2 === void 0 ? void 0 : _a2.getTracks().find((track) => track.kind === "video");
    }
    /**
    ...
    getRemoteAudioTrack(session) {
      var _a2;
      return (_a2 = this.getRemoteMediaStream(session)) === null || _a2 === void 0 ? void 0 : _a2.getTracks().find((track) => track.kind === "audio");
    }
    /**
    ...
    getRemoteVideoTrack(session) {
      var _a2;
      return (_a2 = this.getRemoteMediaStream(session)) === null || _a2 === void 0 ? void 0 : _a2.getTracks().find((track) => track.kind === "video");
    }
    /**
     * Connect.
     * @remarks
      ...
      if (this.options.iceStopWaitingOnServerReflexive) {
        ...
        inviterOptions.delegate.onSessionDescriptionHandler = (sessionDescriptionHandler) => {
          ...
          sessionDescriptionHandler.peerConnectionDelegate = {
            onicecandidate: (event) => {
              var _a2;
              if (((_a2 = event.candidate) === null || _a2 === void 0 ? void 0 : _a2.type) === "srflx") {
    ...
    initSession(session, referralInviterOptions) {
      ...
      session.delegate.onInfo = (info) => {
        var _a2;
        if (((_a2 = this.delegate) === null || _a2 === void 0 ? void 0 : _a2.onCallDTMFReceived) === void 0) {
          info.reject();
          return;
        }
    ...
    constructor(server, options = {}) {
      ...
      const sessionManagerOptions = {
        ...
        delegate: {
          onCallAnswered: () => {
            var _a2, _b2;
            return (_b2 = (_a2 = this.delegate) === null || _a2 === void 0 ? void 0 : _a2.onCallAnswered) === null || _b2 === void 0 ? void 0 : _b2.call(_a2);
          },
          onCallCreated: (session) => {
            var _a2, _b2;
            this.session = session;
            (_b2 = (_a2 = this.delegate) === null || _a2 === void 0 ? void 0 : _a2.onCallCreated) === null || _b2 === void 0 ? void 0 : _b2.call(_a2);
          },
          onCallReceived: () => {
            var _a2, _b2;
            return (_b2 = (_a2 = this.delegate) === null || _a2 === void 0 ? void 0 : _a2.onCallReceived) === null || _b2 === void 0 ? void 0 : _b2.call(_a2);
          },
          onCallHangup: () => {
            var _a2, _b2;
            this.session = void 0;
            ((_a2 = this.delegate) === null || _a2 === void 0 ? void 0 : _a2.onCallHangup) && ((_b2 = this.delegate) === null || _b2 === void 0 ? void 0 : _b2.onCallHangup());
          },
          onCallHold: (s2, held) => {
            var _a2, _b2;
            return (_b2 = (_a2 = this.delegate) === null || _a2 === void 0 ? void 0 : _a2.onCallHold) === null || _b2 === void 0 ? void 0 : _b2.call(_a2, held);
          },
          onCallDTMFReceived: (s2, tone, dur) => {
            var _a2, _b2;
            return (_b2 = (_a2 = this.delegate) === null || _a2 === void 0 ? void 0 : _a2.onCallDTMFReceived) === null || _b2 === void 0 ? void 0 : _b2.call(_a2, tone, dur);
          },
          onMessageReceived: (message) => {
            var _a2, _b2;
            return (_b2 = (_a2 = this.delegate) === null || _a2 === void 0 ? void 0 : _a2.onMessageReceived) === null || _b2 === void 0 ? void 0 : _b2.call(_a2, message.request.body);
          },
          onRegistered: () => {
            var _a2, _b2;
            return (_b2 = (_a2 = this.delegate) === null || _a2 === void 0 ? void 0 : _a2.onRegistered) === null || _b2 === void 0 ? void 0 : _b2.call(_a2);
          },
          onUnregistered: () => {
            var _a2, _b2;
            return (_b2 = (_a2 = this.delegate) === null || _a2 === void 0 ? void 0 : _a2.onUnregistered) === null || _b2 === void 0 ? void 0 : _b2.call(_a2);
          },
          onServerConnect: () => {
            var _a2, _b2;
            return (_b2 = (_a2 = this.delegate) === null || _a2 === void 0 ? void 0 : _a2.onServerConnect) === null || _b2 === void 0 ? void 0 : _b2.call(_a2);
          },
          onServerDisconnect: () => {
            var _a2, _b2;
            return (_b2 = (_a2 = this.delegate) === null || _a2 === void 0 ? void 0 : _a2.onServerDisconnect) === null || _b2 === void 0 ? void 0 : _b2.call(_a2);
          }
        },
