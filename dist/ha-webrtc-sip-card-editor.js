...
exports.WebRTCSipCardEditor = class WebRTCSipCardEditor extends constants.i$1 {
  setConfig(config) {
    this._config = __spreadValues(__spreadValues({}, constants.DEFAULT_CONFIG), config);
  }
  render() {
    ...
    return constants.x`
      <div class="card-config">
        ...
        <ha-textfield
          ...
          .value="${this._config.stun_servers ? this._config.stun_servers.join(",") : constants.DEFAULT_CONFIG.stun_servers.join(",")}"
  ...
  _valueChanged(ev) {
    ...
    if (target.tagName === "HA-SWITCH") {
      ...
      value = target.value || ((_a = ev.detail) == null ? void 0 : _a.value) || target.selected;
...
exports.WebRTCSipCardEditor.styles = constants.i`
    .card-config {
      display: flex;
...
], exports.WebRTCSipCardEditor.prototype, "hass", 2);
__decorateClass([
  constants.n({ attribute: false })
], exports.WebRTCSipCardEditor.prototype, "lovelace", 2);
__decorateClass([
  constants.r()
], exports.WebRTCSipCardEditor.prototype, "_config", 2);
exports.WebRTCSipCardEditor = __decorateClass([
  constants.t("ha-webrtc-sip-card-editor")
], exports.WebRTCSipCardEditor);
